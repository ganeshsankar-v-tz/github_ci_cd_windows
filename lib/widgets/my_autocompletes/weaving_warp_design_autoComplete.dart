...
import '../../model/WarpExcessModel.dart';

class WeavingWarpDesignAutoComplete extends StatefulWidget {
  final Function onChanged;
  final String label;
  final double width;
  final List<WarpExcessModel> items;
  ...
  @override
  State<WeavingWarpDesignAutoComplete> createState() => _State();
}

class _State extends State<WeavingWarpDesignAutoComplete> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Autocomplete<WarpExcessModel>(
        optionsBuilder: (TextEditingValue value) {
          ...
          return widget.items.where((WarpExcessModel option) {
            return option
                .toString()
                .toLowerCase()
              ...
              child: ConstrainedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final WarpExcessModel option = options.elementAt(index);
                    return InkWell(
                      onTap: () {
                        onSelected(option);
