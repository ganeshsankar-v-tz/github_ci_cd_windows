...
class RollerDeliveryWarpIdDropDown extends StatefulWidget {
  ...
  @override
  State<RollerDeliveryWarpIdDropDown> createState() => _State();
}

class _State extends State<RollerDeliveryWarpIdDropDown> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (_, BoxConstraints constraints) {
      return Container(
        ...
        child: Autocomplete<RollerDeliverWarpDetails>(
          optionsBuilder: (TextEditingValue value) {
            ...
            return widget.items.where((RollerDeliverWarpDetails option) {
              var item = value.text.toString().toLowerCase();
              var warpId = '${option.warpId}'.toLowerCase();
              var meter = '${option.metre}'.toLowerCase();
                ...
                child: ConstrainedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      final RollerDeliverWarpDetails option =
