...
class WeavingTransferYarnAutoComplete extends StatefulWidget {
  final Function onChanged;
  final String label;
  final double width;
  final List<WeaverTransferYarnModel> items;
  ...
  @override
  State<WeavingTransferYarnAutoComplete> createState() => _State();
}

class _State extends State<WeavingTransferYarnAutoComplete> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Autocomplete<WeaverTransferYarnModel>(
        optionsBuilder: (TextEditingValue value) {
          ...
          return widget.items.where((WeaverTransferYarnModel option) {
            return option
                .toString()
                .toLowerCase()
              ...
              child: ConstrainedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    final WeaverTransferYarnModel option =
