...
class MyFilterTextField extends StatefulWidget {
  ...
  @override
  State<MyFilterTextField> createState() => _MyTextFieldState();
}

class _MyTextFieldState extends State<MyFilterTextField> {
  @override
  void initState() {
    super.initState();
