...
class MyLetterPadeTextField extends StatefulWidget {
  ...
  @override
  State<MyLetterPadeTextField> createState() => _MyLetterPadeTextFieldState();
}

class _MyLetterPadeTextFieldState extends State<MyLetterPadeTextField> {
  @override
  void initState() {
    super.initState();
