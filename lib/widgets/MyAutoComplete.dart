...
class MyAutoComplete extends StatefulWidget {
  ...
  MyAutoComplete({
    ...
    this.width = 240,
    required this.items,
    this.isContainsSearch = true,
  });

  @override
  State<MyAutoComplete> createState() => _State();
}

class _State extends State<MyAutoComplete> {
