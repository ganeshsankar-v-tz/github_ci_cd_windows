...
class DyerWarpIdSearchField extends StatefulWidget {
  final String label;
  ...
  @override
  State<DyerWarpIdSearchField> createState() => _DyerWarpIdSearchFieldState();
}

class _DyerWarpIdSearchFieldState extends State<DyerWarpIdSearchField> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SearchField<WarpDetailsByWarpDesignIdModel>(
  ...
  suggestions(List<WarpDetailsByWarpDesignIdModel> list, {var query = ''}) {
    final filter = list
        .where(
    ...
    var suggestions = filter.map(
      (e) {
        return SearchFieldListItem<WarpDetailsByWarpDesignIdModel>(
          '${e.warpId}',
          item: e,
          child: Row(
