class ProductDeliverToProcessor {
  int? id;
  int? firmId;
  String? firmName;
  int? dcNo;
  ...
  ProductDeliverToProcessor.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    firmId = json['firm_id'];
