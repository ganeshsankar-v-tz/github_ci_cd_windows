...
class WinderYarnStockReport extends StatefulWidget {
  const WinderYarnStockReport({super.key});

  @override
  State<WinderYarnStockReport> createState() => _WinderYarnStockReportState();
}

class _WinderYarnStockReportState extends State<WinderYarnStockReport> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WindingReportsController>(builder: (controller) {
      return CoreWidget(
        ...
        child: AlertDialog(
          title: const Text('Winding - Yarn Stock Report'),
          shape:
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (dateC.value == true) {
                  request['stock_up_to'] = stockUpToController.text;
                }
                ...
                String? response =
                    await controller.winderYarnStockReport(request: request);
                if (response != null) {
