...
class WinderYarnInwardReport extends StatefulWidget {
  const WinderYarnInwardReport({super.key});

  @override
  State<WinderYarnInwardReport> createState() => _WinderYarnInwardReportState();
}

class _WinderYarnInwardReportState extends State<WinderYarnInwardReport> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WindingReportsController>(builder: (controller) {
      return CoreWidget(
        ...
        child: AlertDialog(
          title: const Text('Winding - Yarn Inward Report'),
          shape:
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                String? response =
                    await controller.winderYarnInwardReport(request: request);
                if (response != null) {
