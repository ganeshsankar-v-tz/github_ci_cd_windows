...
class WeaverPaymentReport extends StatefulWidget {
  const WeaverPaymentReport({super.key});

  @override
  State<WeaverPaymentReport> createState() => _WeaverPaymentReportState();
}

class _WeaverPaymentReportState extends State<WeaverPaymentReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ValueReportController>(builder: (controller) {
      return CoreWidget(
        ...
        child: AlertDialog(
          title: const Text('Weaver Payment Report'),
