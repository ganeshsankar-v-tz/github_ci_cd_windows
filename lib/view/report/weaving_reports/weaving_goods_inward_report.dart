...
class WeavingGoodsInwardReport extends StatefulWidget {
  const WeavingGoodsInwardReport({super.key});

  @override
  State<WeavingGoodsInwardReport> createState() =>
      _WeavingGoodsInwardReportState();
}

class _WeavingGoodsInwardReportState extends State<WeavingGoodsInwardReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<WeavingReportController>(builder: (controller) {
      return CoreWidget(
        ...
        child: AlertDialog(
          title: const Text('Weaving...Goods Inward Report'),
          shape:
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                String? response =
                    await controller.weavingGoodsInwardReport(request: request);
                if (response != null) {
