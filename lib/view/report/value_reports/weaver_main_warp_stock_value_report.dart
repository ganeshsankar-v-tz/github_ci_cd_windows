...
class WeaverMainWarpStockValueReport extends StatefulWidget {
  const WeaverMainWarpStockValueReport({super.key});

  @override
  State<WeaverMainWarpStockValueReport> createState() =>
      _WeaverMainWarpStockValueReportState();
}

class _WeaverMainWarpStockValueReportState
    extends State<WeaverMainWarpStockValueReport> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ValueReportController>(builder: (controller) {
      return CoreWidget(
        ...
        child: AlertDialog(
          title: const Text('Weaver - (Main) Warp Stock - Value Report'),
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                Get.back();
                String? response =
                await controller.WeaverMainWarpStockValueReport(request: request);
                if (response != null) {
