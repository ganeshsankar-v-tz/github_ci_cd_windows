...
class ProcessorInwardPaymentDetails extends StatefulWidget {
  const ProcessorInwardPaymentDetails({Key? key}) : super(key: key);

  @override
  State<ProcessorInwardPaymentDetails> createState() => _State();
}

class _State extends State<ProcessorInwardPaymentDetails> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductInwardFromProcessController>(
        builder: (controller) {
      return CoreWidget(
        appBar: AppBar(title: const Text('Processor Payment Details')),
        bindings: {
