...
class WarpInwardFromRollerPayDetails extends StatefulWidget {
  const WarpInwardFromRollerPayDetails({Key? key}) : super(key: key);

  @override
  State<WarpInwardFromRollerPayDetails> createState() => _State();
}

class _State extends State<WarpInwardFromRollerPayDetails> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WarpInwardFromRollerController>(builder: (controller) {
      return CoreWidget(
        appBar: AppBar(title: const Text('Roller Payment Details')),
        bindings: {
