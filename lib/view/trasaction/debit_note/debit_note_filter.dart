...
class DebitNoteFilter extends StatefulWidget {
  const DebitNoteFilter({super.key});

  @override
  State<DebitNoteFilter> createState() => _DebitNoteFilterState();
}

class _DebitNoteFilterState extends State<DebitNoteFilter> {
