...
class WarpInwardFromDyerPayDetails extends StatefulWidget {
  const WarpInwardFromDyerPayDetails({Key? key}) : super(key: key);

  @override
  State<WarpInwardFromDyerPayDetails> createState() => _State();
}

class _State extends State<WarpInwardFromDyerPayDetails> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WarpInwardFromDyerController>(builder: (controller) {
      return CoreWidget(
        appBar: AppBar(title: const Text('Dyer Payment Details')),
        bindings: {
