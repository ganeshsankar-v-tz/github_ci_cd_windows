...
class ProductPurchaseBottomSheet extends StatefulWidget {
  const ProductPurchaseBottomSheet({Key? key}) : super(key: key);

  @override
  State<ProductPurchaseBottomSheet> createState() => _State();
}

class _State extends State<ProductPurchaseBottomSheet> {
...
//  TextEditingController stockController = TextEditingController();
                                        ...
                                        children: [
                                          MyAutoComplete(
                                            ...
                                            onChanged: (ProductInfoModel item) {
                                              ...
                                              designNoController.text = tryCast(item.designNo);
  ...
  void _initValue() {
    ...
    if (Get.arguments != null) {
      ...
      var productList = controller.ProductName.where(
