...
class AddSareeChecker extends StatefulWidget {
  const AddSareeChecker({super.key});

  static const String routeName = '/add_saree_checker';

  @override
  State<AddSareeChecker> createState() => _State();
}

class _State extends State<AddSareeChecker> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SareeCheckerController>(builder: (controller) {
      return ShortCutWidget(
        appBar: AppBar(
          title: Text(
              "${idController.text == '' ? 'Add' : 'Update'} Saree Checker"),
          actions: [
            Visibility(
              visible: false,
