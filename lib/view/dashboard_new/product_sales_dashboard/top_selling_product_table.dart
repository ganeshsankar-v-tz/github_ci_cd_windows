...
class TopSellingProductTable extends StatefulWidget {
  final TopSellingProductDataSource dataSource;
  ...
  @override
  State<TopSellingProductTable> createState() => _TopSellingProductTableState();
}

class _TopSellingProductTableState extends State<TopSellingProductTable> {
  @override
  void initState() {
    super.initState();
  }
...
class TopSellingProductDataSource extends DataGridSource {
  TopSellingProductDataSource({required List<dynamic> list}) {
    _list = list;
    updateDataGridRows();
  }
